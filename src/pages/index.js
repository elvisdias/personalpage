        ...
        <div class='parent'>
          ...
          <Layout>      
              ...
              <div style={this.divStyle}>
                  ...
                  <h4>
                  This is my home and thus has been thought out to reflect whatever I feel like putting out there. For my playground I should be at <Link class='lab' to='/laboratory'>my laboratory</Link> anytime.
                  </h4>
              </div>        
          </Layout>
        </div>
      ...
      <div class='parent'>
        ...
        <Layout>      
            ...
            <div style={this.divStyle}>
                ...
                <h4>
                 Esse é meu lar, e assim, foi pensado para refletir qualquer coisa que eu sinta que deva colocar para o mundo. Para experimentações eu devo estar no <Link class='lab' to='/laboratory'>meu laboratório</Link> a qualquer momento.
                </h4>
            </div>        
        </Layout>
      </div>
